...
export default function CartModal({ isOpen, onClose, cartItems = [], productsMap = {} }) {
      ...
      <div ref={ref} style={s.drawer}>
        ...
        <div style={s.header}>
          <div style={s.headerLeft}>
            <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24" style={{ color: "#111" }}>
            ...
            return (
              <div key={c.cid} style={s.item}>
                ...
                <div style={s.itemInfo}>
                  ...
                  <p style={s.itemMeta}>Size {c.size} · SL {c.qty}</p>
                </div>
...
const s = {
    ...
    closeBtn: {
      ...
      fontSize: 16, color: "#aaa", padding: "4px 8px", borderRadius: 6,
    ...
    empty: {
      ...
      justifyContent: "center", height: "100%", paddingTop: 80,
    },
    item: {
    ...
    itemImg: {
      ...
      borderRadius: 8, border: "1px solid #eee", flexShrink: 0,
    },
    itemInfo: { flex: 1, minWidth: 0 },
    itemBrand: { fontSize: 10, fontWeight: 700, color: "#bbb", textTransform: "uppercase", letterSpacing: 1, marginBottom: 2 },
    itemName: {
      fontSize: 12, fontWeight: 500, color: "#222", lineHeight: 1.4,
      overflow: "hidden", display: "-webkit-box",
      WebkitLineClamp: 2, WebkitBoxOrient: "vertical",
    },
    itemMeta: { fontSize: 11, color: "#aaa", marginTop: 4 },
    itemPrice: { fontSize: 13, fontWeight: 800, color: "#e53935", whiteSpace: "nowrap", flexShrink: 0 },
    footer: {
      padding: "16px 22px",
    ...
    viewCartBtn: {
      ...
      border: "1.5px solid #111", borderRadius: 12, padding: "11px 0",
